        ...
        <>
            ...
            <Container maxWidth="md" sx={{ mt: 4 }}>
                ...
                <Tabs value={tabIndex} onChange={(_, newValue) => setTabIndex(newValue)} centered data-testid="tabs">
                    <Tab label="Basic Details" data-testid="tab-basic-details" />
                    <Tab label="Address Details" data-testid="tab-address-details" />
                    <Tab label="Company Details" data-testid="tab-company-details" />
                </Tabs>
